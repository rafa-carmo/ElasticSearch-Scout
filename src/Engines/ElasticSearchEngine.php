...
class ElasticSearchEngine extends Engine
{
    ...
    public function update($models)
    {
        ...
        $index = $this->elasticsearch->index($models->first()->searchableAs());
    ...
    {
        $elasticsearch = $this->elasticsearch->index($builder->index ?: $builder->model->searchableAs());
        ...
        return $elasticsearch->rawSearch($builder->query, $searchParams);
    }
    ...
    {
        $index = $this->elasticsearch->index($model->searchableAs());
